    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            {
                uint count = 0; //искомое количество квадратов на прямоугольнике
                double filledA = C; //длина заполненной части прямоугольника вдоль стороны A
                double filledB = C; //длина заполненной части прямоугольника вдоль стороны B
